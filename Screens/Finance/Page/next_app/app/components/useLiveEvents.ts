...
/** The screen's own SSE stream at /api/finance/live - real trace rows,
    ...
    own and we only report what we know. Same shape as every other
    screen's hook (Phase 12.2/12.3/12.4) because the wire contract is the
