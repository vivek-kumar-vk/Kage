...
/** This screen's own live trace feed, off /api/enhancement/live - the
...
export function ActivityRail() {
  const { rows, state } = useLiveEvents("/api/enhancement/live");
  ...
  return (
    ...
    >
      ...
      <ol
        ...
        className="flex max-h-96 flex-col-reverse gap-1 overflow-y-auto"
      >
